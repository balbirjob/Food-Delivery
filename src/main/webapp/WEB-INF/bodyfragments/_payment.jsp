      ...
      <div class="accordion-body"><div class="card">
			...
			<div class="card-body">
				...
				<sf:form method="post"
					...
					<div class="col-md-12">
						<label for="inputEmail4" class="form-label">UPI ID</label>
						 <input type="text" name="checkNo" placeholder="Enter UPI ID" class="form-control" id="inputEmail4"
						 value="" required="required">
					</div>
					...
					<div class="col-md-6">
						<label for="inputEmail4" class="form-label">Mobile Number.</label>
						 <input type="text" name="signature" placeholder="Enter mobile number" class="form-control" id="inputEmail4"
						 value="" required="required">
					</div>
